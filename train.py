...
if not os.path.exists(os.path.join("Datasets", "captcha")):
    download_and_unzip("https://ai_data.dinokhoa.news/dataset.zip",
                       extract_to="Datasets/captcha")

# Create a list of all the images and labels in the dataset
dataset, vocab, max_len = [], set(), 0
captcha_path = os.path.join("Datasets", "captcha")
for file in os.listdir(captcha_path):
    ...
    dataset.append([file_path, answer])
    vocab.update(list(answer))
